...
public class NQueensDemo {
	...
	private static void startNQueensDemo() {
		solveIncrementalNQueensWithAStarSearch();
	}
	
	private static void solveIncrementalNQueensWithAStarSearch() {
		...
		SearchForActions<NQueensBoard, QueenAction> search = new AStarSearch<>
				(new GraphSearch<>(), NQueensFunctions::getIncrementalProbabilityHeuristic);
	...
	private static void solveCompleteNQueensWithAStarSearch() {
	
		System.out.println("\n--- NQueensDemo A* (complete state formulation [v1], graph search 3e) ---");
...
//		System.out.println("\n--- NQueensDemo A* (complete state formulation [v2], graph search 3e) ---");
//		Problem<NQueensBoard, QueenAction> problem = NQueensFunctions.createCompleteStateFormulationProblem (boardSize, Config.QUEEN_IN_EVERY_COL);
		...
		SearchForActions<NQueensBoard, QueenAction> search = new AStarSearch<>
				(new GraphSearch<>(), NQueensFunctions::getNullHeuristic);
